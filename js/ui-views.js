function showCaixasOptions(value) {
    if (value === 'config') {
        ...
        document.getElementById('unicode-skin-div').style.display = 'none';
        ...
        document.getElementById('custom-key-div').style.display = 'block';
        document.getElementById('input-title2').textContent = 'Nome da chave';
    } 
    
    else if (value === 'itens') {
        document.getElementById('custom-key-div').style.display = 'none';
        ...
        document.getElementById('coloredNick').style.display = 'block';
        document.getElementById('unicode-skin-div').style.display = 'block';
